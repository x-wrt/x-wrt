...
static int intel_phy_rd(struct intel_gsw *gsw, GSW_MDIO_data_t *parm) {
	return GSW_MDIO_DataRead((void*)&gsw->pd, parm);
}

static inline int intel_phy_wr(struct intel_gsw *gsw, GSW_MDIO_data_t *parm) {
	return GSW_MDIO_DataWrite((void*)&gsw->pd, parm);
}

static inline int intel_mdio_rd(struct intel_gsw *gsw, u16 Offset, u16 Shift, u16 Size, ur *value) {
	return gsw_reg_rd((void*)&gsw->pd, Offset, Shift, Size, value);
}

static inline int intel_mdio_wr(struct intel_gsw *gsw, u16 Offset, u16 Shift, u16 Size, u32 value) {
	return gsw_reg_wr((void*)&gsw->pd, Offset, Shift, Size, value);
}

static inline int intel_mmd_rd(struct intel_gsw *gsw, GSW_MMD_data_t *parm) {
	return GSW_MmdDataRead((void *)&gsw->pd, parm);
}

static inline int intel_mmd_wr(struct intel_gsw *gsw, GSW_MMD_data_t *parm) {
	return GSW_MmdDataWrite((void *)&gsw->pd, parm);
}

static inline int intel_count_rd(struct intel_gsw *gsw, GSW_RMON_Port_cnt_t *parm) {
	return GSW_RMON_Port_Get((void*)&gsw->pd, parm);
}

static inline int intel_count_clear(struct intel_gsw *gsw, GSW_RMON_clear_t *parm) {
